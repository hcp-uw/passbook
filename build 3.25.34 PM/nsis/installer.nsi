!define PRODUCT_NAME "passbook"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.11.0"
!define PY_MAJOR_VERSION "3.11"
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "passbook_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "passbook"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\passbook.lnk" "$INSTDIR\Python\python.exe" \
      '"$INSTDIR\passbook.launch.py"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\passbook.launch.py"
    Delete "$INSTDIR\glossyorb.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\passbook.lnk"
  RMDir $INSTDIR
